...
infotext <- renderUI({
  HTML(paste(
    ...
    "",
    "How to Navigate: Click on the Impact Area dropdown menu to sort by engagement categories. Select the icons or the Stanford Unit dropdown menu to sort based on Stanford schools and enter list view. Click on the map markers or list items to display more information about a specific hub. Navigate to a previous view using the back button at the top, or click anywhere on the map that's not a marker to return to the home page.",
    sep = "<br>"
  ))
})
...
back_projects <- renderUI({
  actionButton(
    inputId = "back",
    label = "Back to Projects",
    style="background: transparent; border: none; outline: none; color: #1A1A1A; margin-bottom: -10px; margin-left: -15px;"
  )
})
...
empty_button <- renderUI({
  actionButton(
    inputId = "empty",
    label = "-",
    style="background: transparent; border: none; outline: none; color: transparent; margin-bottom: -10px;"
  )
})
...
```{r}
uiOutput("sidebar2", style = "overflow-y: auto; height: 100% !important;")
```
...
output$sidebar2 <- renderUI({
  tagList(
    ...
    uiOutput("back_button", style = "width: 100% !important; height: fit-content !important;"),
    uiOutput("text", style = "width: 100% !important; height: fit-content !important;"),
    div(id = "placeholder_text_descriptive"),
    div(id = "placeholder_theme_box"),
    uiOutput("theme_box", style = "width: 100% !important; height: fit-content !important;"),
    div(id = "placeholder_school_box"),
    div(id = "placeholder_table"),
    div(id = "placeholder_menu"),
    uiOutput("menu_box", style = "overflow-x:scroll !important; width: 100% !important; height: fit-content !important;"),
    div(id = "placeholder_submit_button"),
    uiOutput("submit_button", style="width: 100%; margin-top:30px; margin-bottom:10px; height: fit-content !important;", align = "center"),
    div(id = "placeholder_infotext"),
    uiOutput("infotext", style = "width: 100% !important; height: fit-content !important;")
  )
})

output$back_button <- empty_button
...
observeEvent(input$map_marker_click,{
  ...
  output$text_descriptive <- renderUI({
    ...
    HTML(paste(
      "</br>",
      "</br>",
      if(!is.na(selected_data2$`Logo`)){tags$img(src = selected_data2$`Logo`,style = "max-width:100%; max-height:200px;height:auto;width:auto;")},
      ...
      "</br>",
      "</br>",
      tags$img(src = selected_data2$`Featured Photo`,style = "max-width:100%; max-height:400px;height:auto;width:auto;"),
      "</br>"
    ))
  ...
  if(!is.null(values$school) | !is.null(values$theme_select)){
    ...
    output$back_button <- back_projects
...
observeEvent(input$map_click, {
  ...
  insertUI("#placeholder_submit_button","afterEnd",ui=uiOutput("submit_button", style="width: 100%; margin-top:30px; margin-bottom:10px; height: fit-content !important;", align = "center"))
...
observeEvent(input$back,{
  ...
  if(values$radio_indicator == "icon"){
    ...
    removeUI("#info_text")
    output$infotext <- infotext
    insertUI("#placeholder_infotext", "afterEnd", ui = uiOutput("infotext", style = "width: 100% !important; height:fit-content !important;"))
    ...
    insertUI("#placeholder_theme_box","afterEnd",ui=uiOutput("theme_box", style = "width: 100% !important; height:fit-content !important;"))
    
    insertUI("#placeholder_menu","afterEnd",ui=uiOutput("menu_box", style = "overflow-x:scroll !important; width: 100% !important; height: fit-content !important;"))
    ...
    insertUI("#placeholder_table","afterEnd",ui=div(dataTableOutput('table'), style = "width: 100%"))
...
observeEvent(values$school, {
  ...
  insertUI("#placeholder_school_box","afterEnd",ui=uiOutput("school_box", style = "width: 100% !important; height:fit-content !important;"))
