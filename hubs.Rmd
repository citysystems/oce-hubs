...
infotext <- renderUI({
  HTML(paste(
    ...
    "<ul><li>Point to one or more sustained partnerships with actionable work</li><li>Dedicate resources to sustain the community partnership and engage faculty, staff, and students</li><li>Practice <a href = https://haas.stanford.edu/about/our-approach/principles-ethical-and-effective-service/ target='_blank'>ethical and effective service</a></li></ul>",
    "How to Navigate: ",
